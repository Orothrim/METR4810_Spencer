...
int main(int argc, char** argv) {
	...
	// cout << "Is a new background image required? [y/n]\n\r";
	// cin >> input;
	// cout << input << endl;
	// if(input == 'y' || input == 'Y') {
	...
	Mat image = originalImage.clone(), threshImage, reducedImage, grayImage, erodedImage, colourImages[3], yuvImage, yuvSplit[3], edgeImage, contoursImage, blueImage, redImage, brightImage;
	...
	disImage((char *)"Red Image 2", colourImages[1], 2);
	...
	for(int k = 0; k <= 1; k++) {
		...
		switch(k) {
			case 0:
				...
				break;
			case 1:
				disImage((char *)"Red Image 3", threshImage, 2);
				break;
		}
	}
