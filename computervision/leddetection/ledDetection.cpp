...
int main(int argc, char** argv) {
	...
	Mat frame = originalImage.clone(), threshImage, reducedImage, grayImage, erodedImage, colourImages[3], yuvImage, yuvSplit[3], edgeImage, contoursImage, blueImage, redImage, brightImage;
